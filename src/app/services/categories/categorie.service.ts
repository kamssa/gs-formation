...
// observables streams
  ...
  getAllCategorie(): Observable<Resultat<Categorie[]>> {
    return this.http.get<Resultat<Categorie[]>>(`${environment.urlApi}/api/categorie`);
  }
  ...
  ajoutCategorie(categorie: Categorie): Observable<Resultat<Categorie>> {
    ...
    return this.http.post<Resultat<Categorie>>(`${environment.urlApi}/api/categorie`, categorie);
  }
  modifCategorie(categorie: Categorie): Observable<Resultat<Categorie>> {
    ...
    return this.http.put<Resultat<Categorie>>(`${environment.urlApi}/api/categorie`, categorie);
  }
  getCategorieById(id: Categorie): Observable<Resultat<Categorie>> {
    return this.http.get<Resultat<Categorie>>(`${environment.urlApi}/api/categorie/${id}`);
  }
  supprimerCategorie(id: number): Observable<any> {
    return this.http.delete(`${environment.urlApi}/api/categorie/${id}`);
